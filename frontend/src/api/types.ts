...
export type Backend =
  ...
  | 'paddleocr-vl'      // PaddleOCR-VL v1.6 (0.9B) - CUDA 本地推理；Mac CPU 自动路由到 MLX
  | 'paddleocr-vl-vllm' // PaddleOCR-VL v1.6 (0.9B) - vLLM 加速
  | 'paddleocr-vl-mlx'  // PaddleOCR-VL v1.6 (0.9B) - Apple Silicon MLX
  | 'sensevoice'
  | 'video'
  | 'fasta'             // FASTA 生物序列格式
